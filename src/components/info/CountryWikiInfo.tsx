...
export function CountryWikiInfo({ onError }: { onError: (error: Error) => void }) {
  ...
  if (summaryError)
    return (
      <span className="pointer-events-auto scrollbar-thin max-h-75 max-w-xl scrollbar-thumb-sky-700 scrollbar-track-sky-900 overflow-y-auto rounded-md bg-sky-900/60 p-3 break-all hover:bg-sky-900">
  ...
  return (
    <section className="flex max-h-[60vh] max-w-md flex-col">
      <div className="visible relative scrollbar-thin scroll-p-8 scrollbar-thumb-sky-700 scrollbar-track-sky-900 overflow-y-auto px-4 pb-4 text-justify indent-4 wrap-break-word text-white">
